"""Referenz-Integritätsprüfung (Abschnitt 6.7) – Lernmodus-Komponente.
...
gibt. Und genau so wird in diesem Spike validiert: Ressource für Ressource
über `$validate` (Abschnitt 6.5).
...
Deshalb ist diese Prüfung eine eigenständige, zwingende Komponente und darf
NICHT als "von HAPI mit abgedeckt" betrachtet werden.
