...
OBSERVATION_CODES: dict[str, ObservationCode] = {
    ...
    for o in [
        ...
        ObservationCode("789-8", "Erythrocytes [#/volume] in Blood", "Erythrozyten", "10*6/uL", "10*6/uL", 3.5, 6.0, display_loinc_de="Erythrozyten [#/Volumen] in Blut mittels automatisierter Zählung", snomed="14089001", snomed_display="Red blood cell count"),
        ObservationCode("6690-2", "Leukocytes [#/volume] in Blood", "Leukozyten", "10*3/uL", "10*3/uL", 3.0, 15.0, display_loinc_de="Leukozyten [#/Volumen] in Blut mittels automatisierter Zählung", snomed="767002", snomed_display="White blood cell count"),
        ...
        ObservationCode("2345-7", "Glucose [Mass/volume] in Serum or Plasma", "Glukose im Serum", "mg/dL", "mg/dL", 60.0, 300.0, display_loinc_de="Glucose [Masse/Volumen] in Serum oder Plasma", snomed="22569008", snomed_display="Glucose measurement, serum"),
        ObservationCode("4548-4", "Hemoglobin A1c/Hemoglobin.total in Blood", "HbA1c", "%", "%", 4.5, 14.0, display_loinc_de="Hämoglobin A1c/Hämoglobin.gesamt in Blut", snomed="43396009", snomed_display="Hemoglobin A1c measurement"),
        ...
        ObservationCode("3094-0", "Urea nitrogen [Mass/volume] in Serum or Plasma", "Harnstoff-Stickstoff", "mg/dL", "mg/dL", 6.0, 60.0, display_loinc_de="Harnstoff-Stickstoff [Masse/Volumen] in Serum oder Plasma", snomed="24509005", snomed_display="Urea nitrogen measurement"),
        ObservationCode("98979-8", "Glomerular filtration rate [Volume Rate/Area] in Serum, Plasma or Blood by Creatinine-based formula (CKD-EPI 2021)/1.73 sq M", "geschätzte GFR", "mL/min/{1.73_m2}", "mL/min/{1.73_m2}", 10.0, 120.0, display_loinc_de="Glomeruläre Filtrationsrate [Volumenrate/Fläche] in Serum, Plasma oder Blut mittels Creatinin-basierter Formel (CKD-EPI 2021)/1,73 m²", snomed="80274001", snomed_display="Glomerular filtration rate measurement"),
        ObservationCode("2951-2", "Sodium [Moles/volume] in Serum or Plasma", "Natrium", "mmol/L", "mmol/L", 128.0, 148.0, display_loinc_de="Natrium [Mol/Volumen] in Serum oder Plasma", snomed="104934005", snomed_display="Sodium measurement, serum"),
        ObservationCode("2823-3", "Potassium [Moles/volume] in Serum or Plasma", "Kalium", "mmol/L", "mmol/L", 3.0, 6.0, display_loinc_de="Kalium [Mol/Volumen] in Serum oder Plasma", snomed="59573005", snomed_display="Potassium measurement"),
        ObservationCode("2075-0", "Chloride [Moles/volume] in Serum or Plasma", "Chlorid", "mmol/L", "mmol/L", 95.0, 112.0, display_loinc_de="Chlorid [Mol/Volumen] in Serum oder Plasma", snomed="46511006", snomed_display="Chloride measurement"),
        ObservationCode("2093-3", "Cholesterol [Mass/volume] in Serum or Plasma", "Gesamtcholesterin", "mg/dL", "mg/dL", 110.0, 320.0, display_loinc_de="Cholesterol [Masse/Volumen] in Serum oder Plasma", snomed="77068002", snomed_display="Cholesterol measurement"),
        ObservationCode("2085-9", "Cholesterol in HDL [Mass/volume] in Serum or Plasma", "HDL-Cholesterin", "mg/dL", "mg/dL", 25.0, 95.0, display_loinc_de="Cholesterol in HDL [Masse/Volumen] in Serum oder Plasma", snomed="28036006", snomed_display="High density lipoprotein cholesterol measurement"),
        ObservationCode("2571-8", "Triglyceride [Mass/volume] in Serum or Plasma", "Triglyzeride", "mg/dL", "mg/dL", 50.0, 500.0, display_loinc_de="Triglycerid [Masse/Volumen] in Serum oder Plasma", snomed="14740000", snomed_display="Triglycerides measurement"),
        ObservationCode("1742-6", "Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma", "ALAT (GPT)", "U/L", "U/L", 5.0, 150.0, display_loinc_de="Alanin-Aminotransferase [Enzymaktivität/Volumen] in Serum oder Plasma", snomed="34608000", snomed_display="Alanine aminotransferase measurement"),
        ObservationCode("1920-8", "Aspartate aminotransferase [Enzymatic activity/volume] in Serum or Plasma", "ASAT (GOT)", "U/L", "U/L", 5.0, 150.0, display_loinc_de="Aspartat-Aminotransferase [Enzymaktivität/Volumen] in Serum oder Plasma", snomed="45896001", snomed_display="Aspartate aminotransferase measurement"),
        ObservationCode("1975-2", "Bilirubin.total [Mass/volume] in Serum or Plasma", "Bilirubin gesamt", "mg/dL", "mg/dL", 0.2, 4.0, display_loinc_de="Bilirubin.gesamt [Masse/Volumen] in Serum oder Plasma", snomed="359986008", snomed_display="Bilirubin, total measurement"),
